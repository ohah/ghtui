...
pub enum Message {
    ...
    CodeFileLoaded(String, String, String), // path, filename, content
    CodeImageLoaded(String, String, Vec<u8>), // path, filename, raw image bytes
    ...
    ScrollUp,
    ScrollDown,
    MouseClick(u16, u16),       // single click (column, row)
    MouseDoubleClick(u16, u16), // double click (column, row)
    ...
    ModalEditorChar(char),
    ModalEditorNewline,
    ModalEditorBackspace,
    ModalEditorDelete,
    ModalEditorTab,
    ModalEditorLeft,
    ModalEditorRight,
