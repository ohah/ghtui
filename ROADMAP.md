...
- [x] 리뷰 스레드 resolve/unresolve (`z`키 — GraphQL resolveReviewThread/unresolveReviewThread)
...
- [x] 커밋 히스토리 (`c`키 — 커밋 목록, SHA/메시지/작성자/날짜)
- [x] 커밋 상세 (Enter — 전체 메시지, 파일 변경 목록, additions/deletions)
